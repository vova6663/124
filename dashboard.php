...
<body>
    <div class="container">
                ...
                <p>
                    ...
                    <span class="role-badge">
                        ...
                        switch($_SESSION['role']) {
                            ...
                            case 2: echo "Диспетчер/Бухгалтер"; break;
        ...
        <div class="dashboard-grid">
            ...
            <?php if($_SESSION['role'] == 2): // Диспетчер и Бухгалтер ?>
            <div class="dashboard-card">
                <h3>Диспетчер</h3>
            ...
            <div class="dashboard-card">
                <h3>Бухгалтер</h3>
                <p>Финансовая отчетность и аналитика</p>
                <a href="accountant.php" class="btn">Финансовая панель</a>
            </div>
            <?php endif; ?>
