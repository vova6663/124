            ...
            <nav class="admin-sidebar">
                <div class="admin-nav">
                    <ul>
                        ...
                        <li><a href="?page=reports" class="<?php echo $current_page=='reports'?'active':''; ?>">
            ...
            <main class="admin-content">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            while($user = $users->fetch_assoc()):
                                $role = ['','Директор','Диспетчер','Водитель','Клиент'][$user['role']];
                                $role_class = ['','badge-danger','badge-info','badge-warning','badge-success'][$user['role']];
                ...
                <section class="admin-section active">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <button class="btn btn-secondary" onclick="showAllOnMap()">
                            <i class="fas fa-map-marked-alt"></i> На карте
                        </button>
                    </div>
                        ...
                        <form method="GET" style="display: flex; gap: 15px; flex-wrap: wrap; align-items: flex-end;">
                            ...
                            <div style="min-width: 150px;">
                                ...
                                <select name="status" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 5px;">
                                    ...
                                    <option value="4" <?php echo (isset($_GET['status']) && $_GET['status']==4) ? 'selected' : ''; ?>>Завершен</option>
                                </select>
                            </div>
                ...
                <section class="admin-section active">
                    ...
                    <div class="stat-grid">
                        <div class="stat-card">
                            ...
                            <button class="btn btn-primary" onclick="exportFinanceReport()">
                        ...
                        <div class="stat-card">
                            ...
                            <p>Эффективность сотрудников</p>
                            <button class="btn btn-secondary" onclick="exportStaffReport()">
                                <i class="fas fa-download"></i> Сформировать
                            </button>
                        </div>
                    </div>
                </section>
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <input type="text" name="gos_n" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>Модель:</label>
                ...
                <button type="submit" name="add_transport" class="btn btn-primary">Сохранить</button>
            </form>
        </div>
    </div>
